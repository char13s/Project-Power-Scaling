...
namespace Pixiv.VroidSdk.Legacy
{
    ...
    public class BrowserAuthorize : MonoBehaviour
    {
        ...
        public void OpenBrowser(Action<bool> onRegistered)
        {
            ...
            // ※ Breaking
            _state = Authentication.Instance.BrowserAuthorized(this.RedirectUri, scopedText,
                                                            GetCodeChallenge(),
                                                            (bool isSuccess) =>
                                                            {
        ...
        {
            // ※ Breaking
            Authentication.Instance.RegisterCode(authCode, this.RedirectUri, _codeVerifier);
        }
