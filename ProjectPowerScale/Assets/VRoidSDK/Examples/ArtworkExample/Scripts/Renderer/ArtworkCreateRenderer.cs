...
namespace VRoidSDK.Examples.ArtworkExample.Renderer
{
    public class ArtworkCreateRenderer : IRenderer
    {
        ...
        public void Rendering(RootView root)
        {
            ...
            artworkView.artworkCreateMenuView.isArchivedLabel.Active = _isArchived;

            if (_isArchived)
            {
                artworkView.artworkCreateMenuView.isArchivedLabel.Text = Translator.Lang.Get(ExampleViewKey.ViewArtworkCreateIsArchived);
            }
        }
    }
}
